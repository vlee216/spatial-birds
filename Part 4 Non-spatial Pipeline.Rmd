...
# Round MAD to three decimal places
round2(as.vector(white.ibis.mad[,2]), 3)
```
...
# Round MAD to three decimal places
round2(as.vector(glossy.ibis.mad[,2]), 3)
```
...
# Round MAD to three decimal places
round2(as.vector(great.egret.mad[,2]), 3)
```
...
# Round MAD to three decimal places
round2(as.vector(cattle.egret.mad[,2]), 3)
```
...
# Round MAD to three decimal places
round2(as.vector(snowy.egret.mad[,2]), 3)
```
...
# Round MAD to three decimal places
round2(as.vector(green.heron.mad[,2]), 3)
```
