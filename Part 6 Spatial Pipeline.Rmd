...
It was also developed with reference to the article "Fitting Conditional and Simultaneous Autoregressive Spatial Models in hglm". See the following citation:

Alam, Moudud, Lars Rönnegård, and Xia Shen. "Fitting conditional and simultaneous autoregressive spatial models in hglm." \textit{The R Journal} 7, no. 2 (2015): 5-18.
